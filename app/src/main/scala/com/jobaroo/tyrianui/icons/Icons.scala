...
object Icons:
  ...
  val small: Css   = Css.literal("size-4")
  val regular: Css = Css.literal("size-5")

  private val tokenWrap = Css.literal("inline-flex shrink-0 items-center justify-center text-current")

  def briefcase[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def mapPin[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def globe[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def banknotes[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def tag[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def funnel[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def building[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def document[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def photo[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def plus[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def bars3[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def xMark[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def sun[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def moon[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def arrowRight[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def arrowLeft[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes,
  ...
  def check[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
  ...
  def info[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes |+| Css.literal("shrink-0"),
  ...
  def warn[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes |+| Css.literal("shrink-0"),
  ...
  def error[Msg](classes: Css = regular): TyrianHtml[Msg] =
    glyph(
      classes |+| Css.literal("shrink-0"),
  ...
  private def glyph[Msg](classes: Css, markup: String): TyrianHtml[Msg] =
    span(UiAttrs.classes(tokenWrap |+| classes))().innerHtml(markup)
